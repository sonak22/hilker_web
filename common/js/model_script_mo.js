$(document).ready(function(){
    ...
    $('#prevUrl').attr("href","/content/product_"+prevModel+"_640.html");
    $('#prevImg').attr("src","/common/img/product/hover/"+prevModel+"-prev.jpg");

    $('#nextUrl').attr("href","/content/product_"+nextModel+"_640.html");
    $('#nextImg').attr("src","/common/img/product/hover/"+nextModel+"-next.jpg");
});